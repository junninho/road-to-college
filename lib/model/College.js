export default class College {
    ...
    hasApplicationDeadlinePassed(college) {
        var response = new Date() > college.applicationDeadline ? "Yes" : "No";
        alert(response);
    }

    hasFinancialAidDeadlinePassed(college) {
        var response = new Date() > college.financialAidDeadline ? "Yes" : "No";
        alert(response);
    }
